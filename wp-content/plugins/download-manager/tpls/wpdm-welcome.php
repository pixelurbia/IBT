         ...
         <div class="row">
             ...
             <div class="col-md-4" >
                 <div class="panel panel-default">
                     ...
                     <div style="line-height: 30px;" class="panel-footer">
                         ...
                         <span style="font-size: 11px;" class="label label-success"><i class="fa fa-database"></i> &nbsp;3.1.0</span> &nbsp;<span style="font-size: 11px;" class="label label-info"><i class="fa fa-th"></i> &nbsp;482.11 KB</span>
                     </div>
                 </div>
             </div>
            ...
            <div style="clear: both"></div>
             ...
             <div class="col-md-12 lead">
                 <h3>What's New?</h3>
                 What new with WordPress Download Manager Pro v4.2.2:
             </div>

             <div class="col-md-4 r">

                     <b>New Short-Codes</b>
                     Use <code>[wpdm-package-form]</code> to show only add/edit package form from front-end, <code>[wpdm-list-packages]</code> to list users submitted packages at front-end, <code>[wpdm-edit-profile]</code> short-code to show edit profile form.

             </div>
             <div class="col-md-4 r">

                 <b>Custom Templates</b>
                 You can can use your own templates from yout active theme for different wpdm short-code, So if you need to edit any wpdm default templates, copy <code>tpls</code> dir to your active theme dir and name it <code>downloadmanager</code>
             </div>
