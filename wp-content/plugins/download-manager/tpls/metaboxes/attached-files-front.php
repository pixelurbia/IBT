            ...
            <div id="currentfiles">
                ...
                <table class="table table-striped" id="wpdm-files">
                    ...
                    <tr>
                        ...
                        <th style="width: 130px; display:none; background: transparent;"><?php echo __("Password", "wpdmpro"); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    foreach ($files as $value): ++$file_index;
                        ...
                        <tr class="cfile">
                            ...
                            <td style="width: 150px; display:none;"><input style="height: 25px;width:50px;display: inline" class="form-control" type="text"
