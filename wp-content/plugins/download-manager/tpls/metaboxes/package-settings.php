...
<div id="package-settings" class="tabc">
    <table cellpadding="5" id="file_settings_table" cellspacing="0" width="100%" class="frm">
        ...
        <tr id="downliad_limit_row">
            ...
            <td><input size="10" style="width: 80px" type="number" name="file[download_limit_per_user]" value="<?php echo get_post_meta($post->ID,'__wpdm_download_limit_per_user', true); ?>" /> / user <span class="info infoicon" title="For non-registered members IP will be taken as ID">&nbsp;</span><br/>
       ...
       <tr id="package_size_row">
        ...
        <tr id="access_row">
            ...
            <td>
                <select name="file[access][]"  data-placeholder="<?php _e("Who should be able to download?","wpdmpro"); ?>"  class="chzn-select role" multiple="multiple" id="access" style="min-width: 250px">
                    <?php
