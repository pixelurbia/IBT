...
<?php $cont = isset($post)?$post->post_content:''; wp_editor(stripslashes($cont),'post_content',array('textarea_name'=>'pack[post_content]')); ?>
        ...
        <div class="panel panel-default" id="package-settings-section">
            <div class="panel-heading"><b><?php _e('Files in folder','wpdmpro'); ?></b></div>
            ...
            <div class="panel hide panel-default" <?php if(in_array('package-settings', $hide)) { ?>style="display: none"<?php }?> id="package-settings-section">
...
<div class="col-md-4">
    ...
    <div class="panel panel-default" id="package-settings-section">
        <div class="panel-heading"><b><?php _e('Add Files','wpdmpro'); ?></b></div>
        <div class="panel-body">
            <?php
    ...
    <div class="panel hide panel-default" id="package-settings-section">
    ...
    <div class="panel panel-default" id="package-settings-section">
        <div class="panel-heading"><b><?php _e('Parent Folder','wpdmpro'); ?></b></div>
        <div class="panel-body cat-panel">
            ...
            function wpdm_categories_checkboxed_tree($parent = 0, $selected = array()){
                ...
                foreach($categories as $category){
                    ...
                    echo '<li class="'.$category->name.' cats"><label><input type="checkbox" '.$checked.' name="cats[]" value="'.$category->term_id.'"> '.$category->name.' </label>';
                    echo "<ul>";
    ...
    <div class="panel hide panel-default">
...
<button type="submit" accesskey="p" tabindex="5" id="publish" class="btn btn-success btn-block btn-lg" name="publish"><i class="fa fa-save" id="psp"></i> &nbsp; <?php echo $_GET['task']=='EditPackage'?__('Update Changes','wpdmpro'):__('Save Files/Folder','wpdmpro'); ?></button>
