...
<table cellspacing="0" class="widefat fixed table">
    ...
    <tr valign="top" class="alternate author-self status-inherit" id="post-8">
               ...
               <tr><td><input type="text" readonly="readonly" onclick="this.select()" value="[title]" style="font-size:10px;width: 120px;text-align: center;"></td><td>- <?php echo __('show file/folder title','wpdmpro'); ?></td></tr>                
