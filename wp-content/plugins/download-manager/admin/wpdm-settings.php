...
<div style="clear: both;"></div>
 ...
 <div style="max-width: 1000px;margin:30px" class="panel panel-primary">
     <div class="panel-heading"><button type="submit" class="btn btn-primary pull-right"><i class="sinc fa fa-save"></i> &nbsp; Save Settings</button><h3 class="h">&nbsp;&nbsp;Download Manager Settings <div class="pull-left wpdm-loading" id="wdms_loading"></div></h3>
...
<br>
         ...
         <button type="submit" class="btn btn-primary"><i class="sinc fa fa-save"></i> &nbsp; Save Settings</button>
