            ...
            foreach ($allfiles as $ind => $sfile) {
                ...
                if ($swl) {
                    ...
                    if ($fileinfo[$sfile]['password'] != '' && $pwdlock)
                        ...
                        $fhtml .= "<td width=150 align=center><a rel='noindex nofollow' class='btn btn-primary btn-xs' href='" . wpdm_download_url($file) . "&ind=" . $ind . "'><i style='opacity:0.5;margin-top:0px' class='fa fa-download'></i>&nbsp;".__("Download","wpdmpro")."</a>&nbsp;{$play}</td></tr>";
                } else {
