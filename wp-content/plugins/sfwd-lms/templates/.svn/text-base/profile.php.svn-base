...
<!-- 	<div class="learndash_profile_heading no_radius clear_both">
	...
	<div id="course_list">
		...
		?>
		<div id="course-<?php echo $course->ID; ?>" class="single_course course_<?php echo $i; ?> ">
			...
			<h4>
				...
				<div class="flip" style="display:none;">
					...
					<div>
					<!-- <p class="single_course_content"><?php echo $course->post_content; ?></p> -->
						<div class="right">
							Progress <br><span class="percentage"><?php echo sprintf(__("%s%%", "learndash"), $progress["percentage"]); ?></span>
						</div>
						...
						<a class="resume hide btn button" href="<?php echo $course_link; ?>">Resume</a>
