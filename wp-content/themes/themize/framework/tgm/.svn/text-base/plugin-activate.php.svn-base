...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> 'http://104.236.34.83/import/plugins/js_composer.zip', // The plugin source
		...
		array(
			...
			'source'   				=> 'http://104.236.34.83/import/plugins/essential-grid.zip', // The plugin source
		...
		// Shortcodes
		array(
			'name'     				=> 'Themize Elements', // The plugin name
			'slug'     				=> 'themize-shortcodes', // The plugin slug (typically the folder name)
			'source'   				=> 'http://104.236.34.83/import/plugins/themize-shortcodes.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> 'http://104.236.34.83/import/plugins/templatera.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> 'http://104.236.34.83/import/plugins/revslider.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> 'http://104.236.34.83/import/plugins/envato-wordpress-toolkit-master.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
	...
	$config = array(
		...
		'strings'      		=> array(
			...
			'install_link' 					  			=> _n_noop( '<span>Begin installing plugin</span>', '<span>Begin installing plugins</span>' ),
