...
?>
<div class="row edd-purchase-receipt-container">
<div class="col-md-4 col-md-offset-4">
<div class="entry">
<h3><?php echo apply_filters( 'edd_payment_receipt_products_title', __( 'Download', 'edd' ) ); ?></h3>
							...
							if ( $download_files && is_array( $download_files ) ) :
								...
								foreach ( $download_files as $filekey => $file ) :
									...
									<li class="edd_download_file">
										<i class="fa fa-paperclip"></i> &nbsp;<a href="<?php echo esc_url( $download_url ); ?>" class="edd_download_file_link"><?php echo edd_get_file_name( $file ); ?></a>
									</li>
									<?php
