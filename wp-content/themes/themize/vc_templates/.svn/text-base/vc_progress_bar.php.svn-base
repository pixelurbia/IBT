...
foreach($graph_lines_data as $line) {
    ...
    $output .= '<div class="vc_bar'.$bar_options.'" data-percentage-value="'.($percentage_value).'" data-value="'.$line['value'].'"'.$line['bgcolor'].'><div class="vc_value_tooltip">'.$line['value'].' '.$units.'</div></div>';
    $output .= '</div>';
}
